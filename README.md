...
Jeg vil anbefale at i bruger Tanstack Query til at hente dataen med, men det er valgfrit hvilket library i vil bruge til at hente data. Formålet med opgaven er at kombinere nogle af de koncepter vi har været igennem; Headless CMS, GraphQL og Queries til at bygge en dynamisk side, hvor alt content styres automatisk fra et CMS system. 
...
Siden skal være stylet med et component library (eks. Material UI eller Shadcn) og den skal være responsiv
### Bonus: 
Hvis i når alle kravene er her nogle bonus krav.
